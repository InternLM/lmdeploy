...
@pytest.mark.parametrize('model', get_turbomind_model_list(tp_num=1, is_converted=True))
def test_workspace_chat_tp1(config, cli_case_config, model, worker_id):
    ...
    if 'deepseek-coder' in model.lower():
        return
    result, chat_log, msg = command_line_test(config,
                                              usercase,
...
@pytest.mark.parametrize('model', get_turbomind_model_list(tp_num=2, is_converted=True))
...
@pytest.mark.command_chat
@pytest.mark.gpu_num_1
@pytest.mark.parametrize('model', get_turbomind_model_list(tp_num=1, model_type='base_model', is_converted=True))
...
@pytest.mark.command_chat
@pytest.mark.gpu_num_2
@pytest.mark.parametrize('model', get_turbomind_model_list(tp_num=2, model_type='base_model', is_converted=True))
