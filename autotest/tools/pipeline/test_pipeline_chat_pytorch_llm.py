...
@pytest.mark.gpu_num_1
@pytest.mark.test_ascend
@pytest.mark.parametrize('run_config', get_func_config_list(BACKEND, {'tp': 1}, extra={'enable-prefix-caching': None}))
def test_pipeline_chat_pytorch_prefix_cache_tp1(config, run_config, common_case_config, worker_id):
    run_pipeline_llm_test(config, run_config, common_case_config, worker_id)
