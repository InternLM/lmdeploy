...
Result will be saved in `profile_hf.csv`, which is a comma-separated file with the following fields.

model, batch_size, input_seqlen, gen_len, total_len, first_time, next_time, last_time, total time, throughput(total), throughput(gen)
"""
