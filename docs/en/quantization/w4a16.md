...
The default port of `api_server` is `23333`. After the server is launched, you can send requests with the OpenAI Python SDK or cURL as described in the [API server guide](../llm/api_server.md).

You can also explore and try out the APIs through Swagger UI at `http://0.0.0.0:23333`.
