...
2. NaN value error during quantization: This may be due to a large number of zeros in the weights. May try `--clamp-zeros` option. Note that this may lead to performance drop of the model.
