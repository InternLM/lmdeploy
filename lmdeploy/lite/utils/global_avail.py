...
class GlobalAvailMixin:
    ...
    def global_available(self, key: Union[str, nn.Module] = 'default', group: str = 'default') -> None:
        ...
        Args:
            key (Union[str, nn.Module], optional): Key to save the instance. Defaults to 'default'.
            group (str, optional): Group to save the instance. Defaults to 'default'.
        """
        self._save_instance(self, key, group)

    @classmethod
    def _save_instance(cls, instance: 'GlobalAvailMixin', key: Union[str, nn.Module]  = 'default',
    ...
    def find(cls, key: Union[str, nn.Module] = 'default', group: str = 'default') -> Union[None, 'GlobalAvailMixin']:
        ...
        Args:
            key (Union[str, nn.Module], optional): Key of the instance. Defaults to 'default'.
            group (str, optional): Group of the instance. Defaults to 'default'.

        Returns:
            Union[None, GlobalAvailMixin]: The found instance, or None if it does not exist.
        """
    ...
    def find_group(cls, group: str) -> Dict[Union[str, nn.Module], 'GlobalAvailMixin']:
        ...
        Returns:
            Dict[Union[str, nn.Module], GlobalAvailMixin]: All instances in the group.
        """
    ...
    def instances(cls) -> Dict[str, Dict[Union[str, nn.Module], 'GlobalAvailMixin']]:
        ...
        Returns:
            Dict[str, Dict[Union[str, nn.Module], GlobalAvailMixin]]: All instances.
        """
