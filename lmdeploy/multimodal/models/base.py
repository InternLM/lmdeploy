...
class BaseModel(ABC):
    """Abstract base model class in the multimodal engine."""
    ...
    # @abstractmethod
    # def postprocess(self, model_outputs: torch.Tensor, processed_inputs: List[Dict]) -> List[Dict]:
    #     """
    #     Takes the model outputs and performs post-process.
    #     """
    #     raise NotImplementedError()
