...
class FusedMoELowLatency:
    ...
    def experts(
        ...
        if act_func is None:
            ...
            activated = act_func(gateup_output.flatten(0, 1))
            _quant_fp8_launcher(activated, self.block_size, down_input.flatten(0, 1),
                                down_input_scale.flatten(0, 1), scale_fmt=self.scale_fmt)
        del gateup_output
