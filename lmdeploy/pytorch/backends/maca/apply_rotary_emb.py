...
from lmdeploy.pytorch.kernels.maca import apply_rotary_pos_emb

from ..apply_rotary_emb import ApplyRotaryEmbBuilder, ApplyRotaryEmbImpl


class MacaApplyRotaryEmbImpl(ApplyRotaryEmbImpl):
...
class MacaApplyRotaryEmbBuilder(ApplyRotaryEmbBuilder):
    """Apply rotary embedding implementation builder."""

    @staticmethod
    def build():
        """build implementation."""
        return MacaApplyRotaryEmbImpl()
