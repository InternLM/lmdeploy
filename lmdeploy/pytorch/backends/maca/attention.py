...
@dataclass
class MacaAttentionMetadata(AttentionMetadata):
...
class MacaAttentionImpl(AttentionImpl[MacaAttentionMetadata]):
    """maca attention implementation."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from lmdeploy.pytorch.kernels.maca import (fill_kv_cache,
                                                     paged_attention_fwd)
    ...
    def forward(
        ...
        k_cache: Tensor,
        v_cache: Tensor,
        attn_metadata: MacaAttentionMetadata,
        inplace: bool = False,
    ) -> Tensor:
        """forward."""
...
class MacaAttentionBuilder(AttentionBuilder[MacaAttentionMetadata]):
    """maca attention builder."""
    ...
    def build(
        ...
        **kwargs,
        ...
        """build."""
        return MacaAttentionImpl(num_heads,
                                   head_size,
                                   scale=scale,
