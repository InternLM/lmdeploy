...
from .qwen3_5 import Qwen3_5VisionModel as InternS2MobiusVisionModel
from .qwen3_5_moe import Qwen3_5MoeTopKRouter as InternS2MobiusTopKRouter
from .qwen3_vl import Qwen3VLInputProcessor as InternS2MobiusInputProcessor
...
class InternS2MobiusMetaMoeBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.gate = InternS2MobiusTopKRouter(config, dtype=dtype, device=device)
...
class InternS2MobiusDecoderLayer(Qwen3_5DecoderLayer):
    """Decoder layer."""
...
class InternS2MobiusTextModel(Qwen3_5TextModel):
    ...
    def __init__(self,
        ...
        self.layers = nn.ModuleList([
            InternS2MobiusDecoderLayer(config,
                                        layer_idx,
                                        dtype=dtype,
                                        device=device,
        ...
        self.meta_mlp = nn.ModuleList([
            InternS2MobiusMetaMoeBlock(config,
                                        layer_idx=idx,
                                        dtype=dtype,
                                        device=device,
...
class InternS2MobiusModel(Qwen3_5Model):
    ...
    def __init__(self,
        ...
        self.visual = InternS2MobiusVisionModel(config.vision_config,
                                                dtype=dtype,
                                                device=device,
                                                prefix=add_prefix('visual', prefix))
        self.language_model = InternS2MobiusTextModel(config.text_config,
                                                      dtype=dtype,
                                                      device=device,
...
class InternS2MobiusForConditionalGeneration(Qwen3_5ForConditionalGeneration):
    ...
    def __init__(self,
        ...
        # build preprocessor
        self.input_processor = InternS2MobiusInputProcessor(self.config, dtype)

        # build model
        self.model = InternS2MobiusModel(config, dtype=dtype, device=device, prefix=add_prefix('model', prefix))
        # build lm_head
