try:
    ...
    is_deepep_installed = True
except ImportError:
    is_deepep_installed = False
...
class DeepEPManager:
    ...
    def dispatch(
        ...
        # Todo: enable low latency dispatch if in decode stage
        if True:
            (
                hidden_states,
                topk_idx,
    ...
    def combine(
        ...
        # Todo: enable low latency combine if in decode stage
        if True:
