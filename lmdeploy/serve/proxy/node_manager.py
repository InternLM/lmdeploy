...
class NodeManager:
    ...
    def get_node(self, model_name: str, role: EngineRole = EngineRole.Hybrid) -> Node | None:
    ...
    def get_node_url(self, model_name: str, role: EngineRole = EngineRole.Hybrid) -> str | None:
        """Get node URL."""
