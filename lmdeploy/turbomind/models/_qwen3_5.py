...
"""Qwen3.5 text-only model for the TurboMind source pipeline."""
...
@INPUT_MODELS.register_module(name='_qwen3_5-moe')
@INPUT_MODELS.register_module(name='_qwen3_5')
class _Qwen3_5Model(TextModel):
