...
class Qwen2VLModel(VisionModel):
    ...
    def proc_messages(self, messages, chat_template, chat_template_kwargs=None):
    ...
    def to_pytorch(self, messages, chat_template, tokenizer, chat_template_kwargs=None, **kwargs):
        ...
        prompt, IMAGE_TOKEN = self.proc_messages(messages, chat_template, chat_template_kwargs)
