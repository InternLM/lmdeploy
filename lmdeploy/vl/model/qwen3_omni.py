...
def check_deps():
    try:
        ...
        raise ImportError('please install qwen-omni-utils by '
                          'pip install qwen-omni-utils -U')

    # TODO: zhouxinyu, maybe lazy import when using audio features
    try:
        import soundfile  # noqa: F401
    except ImportError:
        raise ImportError('please install soundfile by '
