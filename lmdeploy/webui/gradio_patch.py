...
"""Modified from https://github.com/lm-
sys/FastChat/blob/v0.2.9/fastchat/serve/gradio_patch.py."""
# flake8: noqa
...
class Chatbot(Changeable, Selectable, IOComponent, JSONSerializable):
    ...
    def __init__(
        ...
        | None = None,  # Parameter moved to Chatbot.style()
        *,
        label: str | None = None,
    ...
    def _process_chat_messages(
        ...
        if chat_message is None:
            ...
            return {
                ...
                'data':
                None,  # These last two fields are filled in by the frontend
                'is_file': True,
            }
        elif isinstance(
                chat_message,
                dict):  # This happens for previously processed messages
            return chat_message
    ...
    def postprocess(
        self,
        y: List[Tuple[str | Tuple | List | Dict | None,
        ...
        for message_pair in y:
            ...
            processed_messages.append((
                ...
                nh3.clean(message_pair[0]) + '</pre>',
                self._process_chat_messages(message_pair[1]),
            ))
        return processed_messages

    def style(self, height: int | None = None, **kwargs):
        """This method can be used to change the appearance of the Chatbot
        component."""
