...
using sm80_bf16_bf16_g1_d128 = Decoding<arch::Sm80, nv_bfloat16, nv_bfloat16, 8, 128>;
...
using sm80_bf16_s8_g1_d128 = Decoding<arch::Sm80, nv_bfloat16, uint8_t, 8, 128>;
...
using sm80_bf16_u4_g1_d128 = Decoding<arch::Sm80, nv_bfloat16, uint4_t, 8, 128>;
template void invokeDecoding<sm80_bf16_u4_g1_d128>(const typename sm80_bf16_u4_g1_d128::ParamType& params);
