...
template<class T>
[[nodiscard]] cudaError_t invokeProcessKV_v2(char**                 blocks,
                                             const T*               k,
                                             const T*               v,
                                             const T*               k_bias,
                                             const T*               v_bias,
...
template<class T>
[[nodiscard]] cudaError_t invokeProcessKV_v2_(const AttentionParams<T>& params)
{
    return invokeProcessKV_v2((char**)params.block_iter_params.block_ptrs,
                              params.k,
                              params.v,
                              params.k_bias,
                              params.v_bias,
...
template<class T>
[[nodiscard]] cudaError_t invokeFlattenKV_v2(T*                     k,
                                             T*                     v,
                                             char**                 blocks,
                                             const int*             cu_k_len,
                                             const int*             cu_block_num,
...
template<class T>
[[nodiscard]] cudaError_t invokeFlattenKV_v2_(const AttentionParams<T>& params, int sum_k_len)
{
    // blocks -> [H, 2, sum_k_len, D]
    return invokeFlattenKV_v2((T*)params.linear_iter_params.kv_cache,
