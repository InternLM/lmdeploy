...
struct Config_U4_d {
    ...
    using Type = typename Sm70_s884<
        ...
        kRowMajor,
        half,
        GroupAxis>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, GroupSize, EpiM, EpiN>::Kernel;
};
...
struct Config_MXF4 {
    ...
    using Type = typename Sm70_s884<
        ...
        kRowMajor,
        half,
        GroupAxis>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, 32, EpiM, EpiN>::Kernel;
};
...
struct Config_E4M3 {
    ...
    using Type = typename Sm70_s884<
        ...
        Transform_Default,
        VoidOperand,
        Operand_B_Pack<fp8_e4m3_t>,
        Transform_HMMA_SIMT_B,
        Operand_V_Pack<uint16_t>,
        kRowMajor,
        half,
        GroupAxis>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, 128, EpiM, EpiN>::Kernel;
};
