...
struct Config_U4_d {
    template<class Config_,
             ...
             int  EpiN         = -1,
             bool FusePrefetch = true>
    using Type = typename Sm80_s16816<
        Arch,
        T,
        kColMajor,
        ...
        kRowMajor,
        half,
        -1>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, GroupSize, EpiM, EpiN, FusePrefetch>::
        Kernel;
};
...
struct Config_U4_g {
    ...
    using Type = typename Sm80_s16816<
        ...
        kRowMajor,
        T,
        0>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, GroupSize, EpiM, EpiN, FusePrefetch>::
        Kernel;
};
...
struct Config_F16_g {
    ...
    using Type = typename Sm80_s16816<
        ...
        Transform_Default,
        VoidOperand,
        Operand_B_Pack<T, kRowMajor, 1>,
        Transform_Default,
        VoidOperand,
        kRowMajor,
        T,
        0>::template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 1, 1, EpiM, EpiN, FusePrefetch>::Kernel;
};
...
struct Config_E4M3 {
    ...
    using Type = typename Sm80_s16816<Arch,
                                      ...
                                      Operand_B<T, kRowMajor, OperandN>,
                                      Transform_Default,
                                      VoidOperand,
                                      kColMajor,
                                      T,
                                      GroupAxis>::
        template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 128, 1, EpiM, EpiN, FusePrefetch>::Kernel;
};
...
struct Config_MXF4 {
    ...
    using Type = typename Sm80_s16816<Arch,
                                      ...
                                      T,
                                      GroupAxis>::
        template Type<Config_, Stages, Raster, PolicyA, PolicyB, SplitK, 32, 1, EpiM, EpiN, FusePrefetch>::Kernel;
};
