...
struct OperandA {
    ...
    using GmemIter   = GmemIteratorSm80<T, gemm::ThreadMap<CTA_M, CTA_K, 8, WARP_CNT>, SmemLayout, Align_M, true, 0>;
...
struct OperandB {
    ...
    using GmemIter   = GmemIteratorSm80<T, gemm::ThreadMap<CTA_K, CTA_N, 8, WARP_CNT>, SmemLayout, Align_N, true, 1>;
    static constexpr Order kOrder = Order::kColMajor;
    static constexpr Pack  kPack  = Pack::kNone;
};
