...
void Registry::f16_f16_f16_grouped_sm80_s16816()
{
    ...
    Add<C::Type<128, 128, 32, 2, 2, 1, D, D, 3, false, 1, 1>>(); // 6
    ...
    Add<C::Type< 96, 64, 64, 2, 2, 1, D, D, 3, false, 1, 1>>(); // 2
    ...
    Add<C::Type< 64, 64, 128, 1, 2, 2, D, S, 3, false, 1, 1>>(); // 4
    Add<C::Type< 32, 64, 128, 1, 2, 2, D, S, 3, false, 1, 1>>();
    Add<C::Type< 16, 64, 128, 1, 2, 2, D, S, 3, false, 1, 1>>(); // 10
