...
void Registry::f16_u4g128_f16_tnt_sm90_s16816()
{
    ...
    // clang-format off
    Add<C::Type<128, 256,  64, 1, 8, 1, D, D, 3, true, 1, 128>>();  // x12.1
    ...
    Add<C::Type<128, 128,  32, 1, 4, 1, D, S, 4, true, 1, 128, 64, 128>>();  
    Add<C::Type<128, 128,  64, 1, 4, 2, D, D, 3, true, 1, 128, 64, 128>>();  // x11.8

    Add<C::Type<96, 256,  32, 1, 8, 1, D, D, 4, true, 1, 128>>();  
    Add<C::Type<96, 256,  32, 1, 8, 1, D, S, 3, true, 1, 128>>();  
    Add<C::Type<96, 128,  32, 1, 4, 1, D, S, 4, true, 1, 128>>();  
    Add<C::Type<96, 128, 128, 1, 4, 2, D, S, 3, true, 1, 128>>();  

    Add<C::Type<64, 256,  32, 1, 4, 1, D, D, 3, true, 1, 128, 64, 128>>();
    Add<C::Type<64, 256,  32, 1, 4, 1, D, D, 4, true, 1, 128, 64, 128>>(); // x11.8
    Add<C::Type<64, 128,  32, 1, 4, 1, D, S, 4, true, 1, 128>>();  
    Add<C::Type<64, 128,  64, 1, 4, 1, D, D, 3, true, 1, 128>>(); // x12.1
    Add<C::Type<64, 128, 128, 1, 4, 2, D, S, 3, true, 1, 128>>();  
    Add<C::Type<64,  64,  64, 1, 2, 2, D, D, 6, true, 1, 128>>(); // x12.1

    Add<C::Type<48, 256,  64, 1, 4, 1, D, S, 3, true, 1, 128, 48, 128>>();
    Add<C::Type<48, 128,  64, 1, 4, 1, D, S, 4, true, 1, 128>>(); 
    Add<C::Type<48, 128, 128, 1, 4, 2, D, S, 3, true, 1, 128>>(); 
