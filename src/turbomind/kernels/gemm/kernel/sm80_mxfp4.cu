...
void Registry::sm80_mxfp4()
{
    ...
    Add<C16::Type<128, 128, 32, 4, 1, 1, D, D, 3, false, 32, 1, 128, 64>>();  // sm 86/89
    Add<C16::Type<128, 96, 32, 4, 1, 1, D, D, 3, false, 32, 1>>();
    Add<C16::Type<128, 64, 32, 4, 1, 1, D, D, 3, false, 32, 1>>();
    Add<C16::Type<128, 32, 32, 4, 1, 1, S, D, 3, false, 32, 1>>();
    Add<C16::Type<128, 16, 32, 4, 1, 1, S, D, 5, false, 32, 1>>();
    Add<C16::Type<128, 16, 64, 4, 1, 1, S, D, 3, false, 32, 1>>();

    using C8 = Config_<bfloat16_t, 8>;
    Add<C8::Type<128, 8, 32, 4, 1, 1, S, D, 5, false, 32, 1>>();
    Add<C8::Type<128, 8, 64, 4, 1, 1, S, D, 3, false, 32, 1>>();
    Add<C8::Type<64, 8, 64, 4, 1, 1, S, D, 5, false, 32, 1>>();
}
