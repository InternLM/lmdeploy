...
using Tile_256x128_S4_1x2 = detail::TileBase<256, 128, 4, WG_1x2, 80, 208, 136, 184>;
struct Tile_384x128_S3_1x2 : detail::TileBase<384, 128, 3, WG_1x2, 40, 232, 56, 224> { static constexpr int kMmaN = 192; };
...
using Tile_128x256_S3_1x2 = detail::TileBase<128, 256, 3, WG_1x2, 72, 216, 112, 192>;
using Tile_128x256_S3_2x1 = detail::TileBase<128, 256, 3, WG_2x1, 40, 232, 56, 224>;
using Tile_128x256_S4_1x2 = detail::TileBase<128, 256, 4, WG_1x2, 72, 216, 112, 192>;
