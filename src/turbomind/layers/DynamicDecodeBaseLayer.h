...
protected:
    ...
    void         allocateBuffer() = 0;
    virtual void freeBuffer()     = 0;

public:
    DynamicDecodeBaseLayer(cudaStream_t stream, IAllocator* allocator, DynamicDecodeCommonArgs args):
        BaseLayer(stream, nullptr, allocator, false, nullptr), args_(args){};
