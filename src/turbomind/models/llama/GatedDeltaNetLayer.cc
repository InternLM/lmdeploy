...
GatedDeltaNetLayer::GatedDeltaNetLayer(DataType                state_dtype,
    ...
    num_k_heads_(prototype.num_k_heads / engine.attn_tp_size),
    num_v_heads_(prototype.num_v_heads / engine.attn_tp_size),
    key_head_dim_(prototype.key_head_dim),
    value_head_dim_(prototype.value_head_dim),
    d_conv_(prototype.d_conv),
    conv_dim_(num_k_heads_ * key_head_dim_ * 2 + num_v_heads_ * value_head_dim_),
    num_linear_layers_(0),
    layer_types_(layer_types),
    enable_linear_prefix_caching_(engine.enable_prefix_caching),
    linear_prefix_cache_interval_tokens_(engine.cache_block_seq_len * engine.linear_prefix_cache_interval_blocks),
    dtype_(prototype.data_type),
