...
def test_named_state_cache_property_returns_dict_without_layer_maps():
    cache_engine = object.__new__(StateCacheEngine)
    cache_engine._state_cache_names = ['state_0']
    cache_engine._state_caches = [torch.empty(1)]
    cache_engine._state_cache_layer_maps = {}
